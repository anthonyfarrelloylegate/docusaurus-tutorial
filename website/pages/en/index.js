...
class HomeSplash extends React.Component {
  render() {
    ...
    return (
      <SplashContainer>
      <Logo img_src={`${baseUrl}img/undraw_analytics_5pgy.svg`} />
        <div className="inner">
    ...
    const TryOut = () => (
      <Block id="try">
        {[
          {
            content:
              'With WCM Reporting, Watson Care Manager users can run reports, access dashboards,'
              + ' and create custom reports and dashboards based on data that is recorded in the Care Team application.' +
